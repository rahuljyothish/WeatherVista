    ...
    <header>
      <div className="flex justify-center items center">
        <div className="flex justify-center">
            ...
            <h1 className="text-md font-semibold md:text-2xl mt-6">WeatherVista</h1>
        </div>
     </div>
        ...
        <form onSubmit={handleSearch} className="flex gap-x-1">
          ...
          />
          <button type="submit" className="bg-white opacity-80 p-2 rounded-full flex justify-center"> <img src={searchIcon} alt="search" className="w-6 h-6" />
            </button>
        </form>
        </div>
    </header>
